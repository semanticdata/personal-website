...
<p><Link href="https://mabuya.vercel.app/">Mabuya</Link> is a minimal <Link href="https://www.getzola.org">Zola</Link> theme for building light and SEO-ready blogs. Put your work front and center with Mabuya as the base of your project.</p>
...
<p>Source code in this project is available under the <Link href="https://github.com/semanticdata/mabuya/blob/main/LICENSE">MIT License</Link>.</p>
