...
<p>Source code in this project is available under the <Link href="https://github.com/semanticdata/new-tab-bookmarks/blob/main/LICENSE">MIT License</Link>.</p>
